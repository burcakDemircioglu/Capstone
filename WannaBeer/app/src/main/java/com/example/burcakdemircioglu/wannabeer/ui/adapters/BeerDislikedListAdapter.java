 ...
 */
public class BeerDislikedListAdapter extends CursorAdapter {
    Context activity;
    public BeerDislikedListAdapter(Context context, Cursor cursor) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        String name = cursor.getString(DislikedBeersLoader.Query.BEER_NAME);
        String country = cursor.getString(DislikedBeersLoader.Query.BEER_NAME);
